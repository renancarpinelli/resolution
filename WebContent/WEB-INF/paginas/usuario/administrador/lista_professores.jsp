...
var pagAtual = 0;
   ...
   function paginar(tabela){
	   ...
	   var json = buscarAjax("../"+tabela+"Professores");   
	   ...
	   var professor;
    		...
    		for (var i = pagAtual * qtdPorPagina; i < tamanho && i < (pagAtual+1)* qtdPorPagina; i++){
    			professor = json[i];
    			if(professor.tipoEstadoUsuario == (tabela).toUpperCase()){
    				tbodyAtivo.append(
    				    $("<tr id='linha_"+professor.id+"'>")
    				    .append($("<td >").append(professor.id))
    				    .append($("<td>").append(professor.nome))
    				    .append($("<td>").append(professor.email))	
    				  	.append($("<td>").append("<a href='perfilProfessor/"+professor.id+"'> <i class='material-icons'>visibility</i></a>"))	
    			);
    			}
    		}
		...
		<div class="card-header" data-background-color="green">
			<div class="nav-tabs-navigation">
				<div class="nav-tabs-wrapper">
					<span class="nav-tabs-title">Lista de Professores:</span>
...
<div class="col-md-6">
	<div class="card card-nav-tabs">
		<div class="card-header" data-background-color="green">
			<div class="nav-tabs-navigation">
				<div class="nav-tabs-wrapper">
					<span class="nav-tabs-title">Professores em Aguardo:</span>
					<ul class="nav nav-tabs" data-tabs="tabs">
