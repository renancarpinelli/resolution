...
var pagAtual = 0
   ...
   function paginar(tabela){
       ...
       var json = buscarAjax("../services/professor/questoesInativas/${professorLogado.id}");   
...
<a class="btn btn-primary" href='<c:url value="listasMinhasQuestoes"></c:url>'>
	Questões ativas 
...
<div class="col-md-10 col-md-offset-1">
	<div class="card card-plain">
		<div class="card-header" data-background-color="red">
			<h4 class="title">Questões Inativas</h4>
			<p class="category">Lista de questões Inativas </p>
		</div>
	</div>
	...
	<div class="card-footer text-center">
		<div class="col-md-12">
			<button class="btn btn-danger btn-sm pull-left" id="anteriorativo">
				Anterior
				<div class="ripple-container"></div>
			</button>
			<span id="numeracaoativo" class=""></span>
			<button class="btn btn-danger btn-sm pull-right" id="proximoativo">
				Proximo
				<div class="ripple-container"></div>
			</button>
		</div>
