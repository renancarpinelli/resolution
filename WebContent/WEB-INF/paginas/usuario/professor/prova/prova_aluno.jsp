			...
			<div class="col-md-12 questao">
				...
				<div class="col-md-1">
					<input type="number" value="${resposta.nota }" name="nota"
						class="nota" step="1" required="required"
				...
				<div class="col-md-10">
					...
					<c:if
						...
						<div>${provaDoAluno.prova.questoesDaProva[i.count-1].questao.respostas[0].resp_esperada  }</div>

						<div class="form-group">
							<input type="text" name="parecer" required="required"
								<c:if test="${resposta.parecer != null   }"> value="${resposta.parecer }" </c:if>
								placeholder="Parecer" class="form-control "> <span
								class="material-input"></span>
						</div>
